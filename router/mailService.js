...
const sendOTP = async (recipientEmail) => {
    try {
        ...
        const mailOptions = {
            ...
            to: recipientEmail,
            subject: "Verify your email address for CodeKing",
            html: `<!DOCTYPE html>
                    <html lang="en">
                    <head>
                        <meta charset="UTF-8">
                    ...
                    <body style="margin: 0; padding: 0;">
                        <center style="margin: 5px; padding: 5px;">
                            <div style="padding: 10px;">
                                <h1 font-size: 38px;">
                                <span style="color: rgb(0, 255, 0);">{</span><span style="color: black;">Code King</span><span style="color: rgb(255, 128, 0);">}</span>
                                </h1>
                            </div>
                            ...
                            <div style="background-color: rgb(232, 253, 255); height: auto; width: 40vmax; padding: 10px;">
                                <p style="font-size: large; color: rgb(42, 53, 52);">
                                    ...
                                    <a style="color: rgb(255, 123, 0);" href="https://www.CodeKing.tech">Code King</a> account.
                                </p>
                                <br><br>
                                ...
                                <p style="color: rgb(42, 53, 52); font-size: larger;">
                                    Website - <a style="color: rgb(103, 132, 240);" href="https://www.codeking.tech">Code King</a>
                                </p>
                            </div>
                            <hr style="width: 40vmax; background-color: rgb(255, 123, 0);">
                        </center>
